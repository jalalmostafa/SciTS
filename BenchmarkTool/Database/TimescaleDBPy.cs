    ...
    public class TimescaleDBPy : IDatabase
    {
        ...
        public Task<QueryStatusRead> OutOfRangeQuery(OORangeQuery query)
        {
            ...
            catch (Exception ex)
            {
                ...
                return Task.FromResult(new QueryStatusRead(false, 0, new PerformanceMetricRead(0, 0, 0, query.StartDate, query.DurationMinutes, 0, Operation.OutOfRangeQuery), ex, ex.ToString()));
            }
        }
        ...
        public Task<QueryStatusRead> AggregatedDifferenceQuery(ComparisonQuery query)
        {
            try
            {
                ...
                sw.Stop();
                return Task.FromResult(new QueryStatusRead(true, points, new PerformanceMetricRead(sw.Elapsed.TotalMicroseconds, points, 0, query.StartDate, query.DurationMinutes, 0, Operation.DifferenceAggQuery)));
            }
            catch (Exception ex)
            {
                Log.Error(string.Format("Failed to execute Difference beween agg sensor values query. Exception: {0}", ex.ToString()));
                return Task.FromResult(new QueryStatusRead(false, 0, new PerformanceMetricRead(0, 0, 0, query.StartDate, query.DurationMinutes, 0, Operation.DifferenceAggQuery), ex, ex.ToString()));
            }
        }
        ...
        public Task<QueryStatusRead> RangeQueryAgg(RangeQuery query)
        {
            ...
            catch (Exception ex)
            {
                ...
                return Task.FromResult(new QueryStatusRead(false, 0, new PerformanceMetricRead(0, 0, 0, query.StartDate, query.DurationMinutes, _aggInterval, Operation.RangeQueryAggData), ex, ex.ToString()));
            }
        }
        ...
        public Task<QueryStatusRead> RangeQueryRaw(RangeQuery query)
        {
            try
            {
                ...
                return Task.FromResult(new QueryStatusRead(true, points, new PerformanceMetricRead(sw.Elapsed.TotalMicroseconds, points, 0, query.StartDate, query.DurationMinutes, _aggInterval, Operation.RangeQueryRawData)));
            }
            catch (Exception ex)
            {
                Log.Error(String.Format("Failed to execute Range Query Raw Data. Exception: {0}", ex.ToString()));
                return Task.FromResult(new QueryStatusRead(false, 0, new PerformanceMetricRead(0, 0, 0, query.StartDate, query.DurationMinutes, _aggInterval, Operation.RangeQueryRawData), ex, ex.ToString()));
            }
        }
        public Task<QueryStatusRead> RangeQueryRawAllDims(RangeQuery query)
        {
            try
            {
                ...
                sw.Stop();
                return Task.FromResult(new QueryStatusRead(true, points, new PerformanceMetricRead(sw.Elapsed.TotalMicroseconds, points, 0, query.StartDate, query.DurationMinutes, _aggInterval, Operation.RangeQueryRawAllDimsData)));
            }
            catch (Exception ex)
            {
                Log.Error(String.Format("Failed to execute Range Query Raw Data. Exception: {0}", ex.ToString()));
                return Task.FromResult(new QueryStatusRead(false, 0, new PerformanceMetricRead(0, 0, 0, query.StartDate, query.DurationMinutes, _aggInterval, Operation.RangeQueryRawAllDimsData), ex, ex.ToString()));
            }
        }
        ...
        public Task<QueryStatusRead> StandardDevQuery(SpecificQuery query)
        {
            ...
            catch (Exception ex)
            {
                ...
                return Task.FromResult(new QueryStatusRead(false, 0, new PerformanceMetricRead(0, 0, 0, query.StartDate, query.DurationMinutes, 0, Operation.STDDevQuery), ex, ex.ToString()));
            }
        }
